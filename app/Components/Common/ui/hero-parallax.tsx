...
export const Header = () => {
  return (
    <div className="max-w-7xl relative mx-auto py-20 md:py-40 px-4 w-full left-0 top-0">
      ...
      <p className="max-w-2xl text-base md:text-xl mt-8 text-gray-600 dark:text-neutral-200">
        A collection of my projects that I have worked on over the years.
      </p>
    </div>
  );
};
    ...
    >
      ...
      >
        <Image
          ...
          height="600"
          width="600"
          className="object-contain absolute h-full w-full inset-0 bg-gray-100 dark:bg-gray-800"
          alt={product.title}
        />
